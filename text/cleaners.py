...
from text.english import (english_to_ipa, english_to_ipa2, english_to_lazy_ipa,
...
# )
from text.korean import (divide_hangul, fix_g2pk2_error, korean_to_ipa,
                         korean_to_lazy_ipa, latin_to_hangul, number_to_hangul)
